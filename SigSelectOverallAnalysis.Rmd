...
biallele <- read.table("../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/SmartPCA/20180415_biallele.csv", sep = ",", header = T)
...
structuredata <- data.table::fread("../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/STRUCTURE/1_batch_20180415.structure.tsv")

evanno <- data.table::fread("../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/STRUCTURE/STRUCTUREharvester/evannoTable.tab")
colnames(evanno) <- c("K", "Reps",	"Mean_LnP_K", "Stdev_LnP_K", "Ln_K",	"abs_Ln_K", "Delta_K")

#Original SmartPCA run
PCA.dat <- data.table::fread("../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/SmartPCA/20180415.pca.evec")

PCA.eigen <- as.data.frame(data.table::fread("../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/SmartPCA/20180415.eval"))
...
#pdf(file="../figures/PlotSmartPCA", height=6, width=8)
