...
biallele <- read.table("../ProcessRadtags/SS_20180325_U_Pop20_Ind.80_m5_M7_n7/SmartPCA/20180325_biallele.csv", sep = ",", header = T)
...
structuredata <- data.table::fread("../ProcessRadtags/SS_20180325_U_Pop20_Ind.80_m5_M7_n7/STRUCTURE/1_batch_20180325.structure.tsv")
