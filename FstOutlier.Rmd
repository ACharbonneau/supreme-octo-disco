...
for( fst_file in c(1:length(File_list$runname))){
  ...
  print(ggplot(fst_comp, aes(Locus.ID, Smoothed.Fst, col= LOD, shape=sigFisherP )) + 
...
```{r}
plot_bayescan("../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/SS_20180415_P_Pop20_Ind.80_m2_n7_Baye_fst.txt",FDR=0.05)
```
