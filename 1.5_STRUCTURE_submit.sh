...
sed s/INDIVIDUALSGOHERE/${INDIVIDS}/ ../../../../supreme-octo-disco/mainparams4h > mainparams
...
head -1 nohead_${BATCH} > ${rep}_${BATCH}
    ...
    qsub ../../../../supreme-octo-disco/Random_STRUCTURE.qsub -N ${rep}_STRUCTURE -t 3-22 -v thisfile=${rep}_${BATCH}

    #qsub ../../../../supreme-octo-disco/Random_STRUCTURE_Long.qsub -N ${rep}_STRUCTURE -t 6-22 -v thisfile=${rep}_${BATCH}
