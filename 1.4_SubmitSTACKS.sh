...
qsub ../../supreme-octo-disco/1.4.1_stacks_analysis.qsub -v dataAbv="AE2",stackslist="AE_F2_stacks_list",cslist="AE_F2_cs_stacks_list",popfile="AE_data.pop",popmin="4",indivmin=".75"
...
qsub ../supreme-octo-disco/1.4.1_Ustacks_analysis.qsub -v dataAbv="Rrr",Ustackslist="SS_Rrr_stacks_fastqs",cslist="SS_Rrr_cs_stacks_list",popfile="SS_data.pop",popmin="5",indivmin=".5"
