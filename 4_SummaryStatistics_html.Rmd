...
ALLTHEALLELES <- read.structure(file = "../ProcessRadtags/SS_20180415_P_Pop20_Ind.80_m2_n7/STRUCTURE/nohead_batch_20180415.structure.stru", n.ind = 258, n.loc = 1116, onerowperind = F, col.lab = 1, col.pop = 0, row.marknames = 1, NA.char = "-9", col.others = FALSE )
